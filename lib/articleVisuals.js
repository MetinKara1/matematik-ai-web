...
const groupsBySlug = {
  ...
  'fonksiyonlar-ve-grafikler': 'graph',
  'ustel-ve-logaritmik-fonksiyonlar': 'special',
  'trigonometrik-fonksiyonlar': 'special',
  'birim-cember-ve-radyan': 'special',
  'temel-trigonometrik-ozdeslikler': 'special',
  'limit-nedir': 'geometry',
  'limit-alma-kurallari': 'rules',
  'sagdan-ve-soldan-limit': 'graph',
  'limitte-belirsizlikler': 'rules',
  'sureklilik-nedir': 'graph',
  'sureksizlik-turleri': 'graph',
  'turevlenebilirlik-ve-sureklilik': 'geometry',
};
